import { useRegisterUser } from "./register-user-view-model";
    ...
    <>
      <Card className="w-[80%]">
        <CardBody className="py-8 pr-10">
          ...
          <h1 className="mt-4 text-[32px] text-[#514E4E] font-bold">Sign Up</h1>
          ...
          <form>
            <div className="mt-8 flex flex-col gap-4">
              ...
              />
              <Button type="submit" color="blue" children={"Register"} />
            </div>
          </form>
